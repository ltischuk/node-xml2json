...
function startElement(name, attrs) {
	...
	if (! (name in currentObject)) {
		if(options.arrayNotation && isChildOfAccessoServiceCall()) {
...
function isChildOfAccessoServiceCall(){

    return ancestors.length >0 && typeof ancestors[0].SERVICE !== 'undefined';
